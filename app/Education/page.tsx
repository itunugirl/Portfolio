...
const EducationPage = () => {
  ...
  return (
    <section id="education" className="bg-educationbackground min-h-screen py-10 px-4 sm:px-8">
      <div className="mb-10">
        <h1 className="text-2xl sm:text-lg font-bold font-Libre-Baskerville text-gray-800 mb-2" data-aos="fade-up">
          My Educational Journey
        </h1>
        <div className="mb-4">
          <hr className="border-b-2 border-gray-300 ml-24 mr-20" data-aos="fade-right" />
        </div>
        <p className="text-base sm:text-lg text-gray-600 mb-8 text-center" data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="mb-8 flex justify-end pr-2 sm:pr-6" data-aos="fade-right">
            <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 w-full sm:w-3/5">
              <h3 className="text-lg sm:text-xl font-semibold text-pink-400">AltSchool Africa</h3>
          ...
          <div className="mb-8 flex justify-start pl-2 sm:pl-6" data-aos="fade-left" data-aos-delay="100">
            <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 w-full sm:w-3/5">
              <h3 className="text-lg sm:text-xl font-semibold text-pink-400">University of Lagos</h3>
          ...
          <div className="mb-8 flex justify-end pr-2 sm:pr-6" data-aos="fade-right" data-aos-delay="200">
            <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 w-full sm:w-3/5">
              <h3 className="text-lg sm:text-xl font-semibold text-pink-400">Cadel High School</h3>
      ...
      <div className="max-w-4xl mx-auto mt-12" data-aos="fade-up">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">Certifications & Achievements</h2>
      ...
      <div className="text-center mt-16" data-aos="fade-up">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">Let&apos;s Connect!</h2>
        <p className="text-gray-700 mb-4">I&apos;m always open to networking and collaboration!</p>
        <a
          href="mailto:itunuoluwafelicia@example.com"
          className="inline-block bg-buttoncoral text-white px-6 py-3 rounded-lg hover:bg-buttoncoral-hover transition duration-300 ease-in-out"
        >
          Contact Me
        </a>
      </div>
